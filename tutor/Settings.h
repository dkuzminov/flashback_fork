...
public:
    ...
    static QString GetDefaultLanguage() { return "Latin"; }
    static QString GetDatabasePath() { return "<Hardcoded Path>"; }
    static QString GetMotto() { return "For the things we have to learn before we can do, we learn by doing."; }
};
...
public:
    ...
    QString GetMotto() { return HardcodedSettings::GetMotto(); }
